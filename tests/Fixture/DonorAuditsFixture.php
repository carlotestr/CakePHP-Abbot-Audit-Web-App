 ...
 * DonorAuditsFixture
 */
class DonorAuditsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'audit_collectiondate' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'audit_processdate' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'fatal_hipaa' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'nonfatal_greeting' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'nonfatal_purpose' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'nonfatal_callproper' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'nonfatal_updateacc' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'nonfatal_doc' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'nonfatal_log' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'nonfatal_handling' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'daudit_emp_id_idx' => ['type' => 'index', 'columns' => ['emp_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'daudit_emp_id' => ['type' => 'foreign', 'columns' => ['emp_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'audit_collectiondate' => 'Lorem ipsum dolor sit amet',
                'audit_processdate' => 'Lorem ipsum dolor sit amet',
                ...
                'fatal_hipaa' => 'Lorem ipsum dolor sit amet',
                'nonfatal_greeting' => 'Lorem ipsum dolor sit amet',
                'nonfatal_purpose' => 'Lorem ipsum dolor sit amet',
                'nonfatal_callproper' => 'Lorem ipsum dolor sit amet',
                'nonfatal_updateacc' => 'Lorem ipsum dolor sit amet',
                'nonfatal_doc' => 'Lorem ipsum dolor sit amet',
                'nonfatal_log' => 'Lorem ipsum dolor sit amet',
                'nonfatal_handling' => 'Lorem ipsum dolor sit amet',
                'call_summary' => 'Lorem ipsum dolor sit amet',
                'created' => '2021-10-01 09:55:24',
                'modified' => '2021-10-01 09:55:24'
            ],
        ];
        parent::init();
    }
