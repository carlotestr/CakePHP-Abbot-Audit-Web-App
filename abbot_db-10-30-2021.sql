...
--
-- Host: localhost    Database: abbot_db
-- ------------------------------------------------------
...
CREATE TABLE `agent_disputes` (
  ...
  CONSTRAINT `adispute_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE
...
CREATE TABLE `bat_audits` (
  ...
  CONSTRAINT `baudit_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE
...
CREATE TABLE `donor_audits` (
  ...
  CONSTRAINT `daudit_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `error_coachings` (
  ...
  CONSTRAINT `ecoaching_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qa_coachings` (
  ...
  CONSTRAINT `qcoaching_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE
...
CREATE TABLE `qa_goals` (
  ...
  PRIMARY KEY (`id`),
  KEY `emp_id_idx` (`emp_id`),
  CONSTRAINT `qgoal_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE
...
INSERT INTO `users` VALUES (13,'TEST-001','2021-04-22','Denny','Martinez','Denny Martinez','denny.itdwebdev@gmail.com','QA Manager','Donor Contact','13','','denny.itdwebdev@gmail.com','1628592219751.jpg','10bb25a3-ddaf-4fb7-9952-f7fbb5f91bd9','$2y$10$GQRaNnPXTmNaTVhIcs5wY.m.fWPU0eX7iDXZ5agL6zSU9d8hqxv.6','NryolTwb',10,'2021-10-04 08:10:14','2021-10-20 05:16:02'),(14,'TEST-002','2021-10-01','Jane','Doe','Jane Doe','hotmarycorleone@gmail.com','Supervisor/MSE','Donor Contact','13','','hotmarycorleone@gmail.com',NULL,NULL,'$2y$10$hisLwpWdE5k2GoWjcA3XeeUihqTA902h7HX0.1kb/uNrXLnOfAdxG','2AyWANhL',13,'2003-12-31 16:14:03','2021-10-28 07:06:11'),(15,'TEST-003','2016-11-16','Luckylyn','Voz','Luckylyn Voz','lucklylyn@test.com','Agents/Employees','Breathe Alcohol','14','','TEST-003',NULL,NULL,'$2y$10$6uRCY6ud3hgOoeiiT9UJJ.ZZG9boaMonI5z0A49qd.eM2fHajtJ8u',NULL,14,'2021-10-20 05:49:56','2021-10-20 05:49:56'),(16,'TEST-004','2015-11-16','Jericho','Aguilon','Jericho Aguilon','jaguilon@test.com','QA Analysts','Breathe Alcohol','','','TEST-004',NULL,NULL,'$2y$10$o1aarud51PGYxFWOoFR2EOwjdSjqQlecP4y6Y6pZziTGEdxovcWSq','0eX5gGZJ',15,'2021-10-20 05:55:42','2021-10-27 05:55:50'),(17,'TEST-005','2021-10-27','Denny','Martinez','Denny Martinez','denny.itdwebdev@gmail.com','Administrator','Breathe Alcohol','','','TEST-005',NULL,NULL,'$2y$10$kMJeS/g0vk16VvVtxMe.Ru0yA5dwI80YSW466OW86bAJ8FxMisjda',NULL,15,'2021-10-27 04:43:59','2021-10-27 04:43:59');
...
-- Dump completed on 2021-11-01 15:43:32
